...
class Conectar{
    ...
    public function conexion(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
             ...
             $con = pg_connect("host=34.239.169.3 port=5432 dbname=erp_riesgos user=postgres password=@Fcpc.2021");
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
		        $pdo = new PDO('pgsql:host=34.239.169.3;port=5432;dbname=erp_riesgos', 'postgres', '@Fcpc.2021' );
