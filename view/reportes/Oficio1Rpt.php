...
include dirname(__FILE__).'\..\..\view\mpdf60\mpdf.php';
//include('view/mpdf/mpdf.php'); 


include'../../core/ConectarService.php';
$cn = new ConectarService();
$conn = $cn->conexion();


$template = file_get_contents('view/reportes/template/Oficio1.html');
$footer = file_get_contents('view/reportes/template/FooterOfi.html');
...
$mpdf->debug = true;
$directorio = $_SERVER ['DOCUMENT_ROOT'].'/erp_riesgos/DOCUMENTOS_GENERADOS/OFICIOS/oficios_generados/';
