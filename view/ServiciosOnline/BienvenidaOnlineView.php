...
<html lang="en">
  ...
  <body class="hold-transition skin-green fixed sidebar-mini">
	  ...
	  <div class="modal fade" id="mdlRepresentantes" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog modal-md">
        <div class="modal-content">
           <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal">&times;</button>
             <p style="text-align: center;"><b>VALIDACIÓN DE SOLICITUD DE REPRESENTANTE PRINCIPAL DE LA ASAMBLEA GENERAL</b></p> 
           </div>
            <div class="modal-body" style="text-align: center;" >
            <img src="" alt="" class="img-fluid">
				
			<p style="text-align: centar;">Usted registró una solicitud de como representante a la Asamblea General . ¿Usted desea validar este registro?.</p> 			  
           
		   
		   
			<a onclick="cambiar_estado(<?php echo $allusers?>, 1);" class="btn btn-info">SI ACEPTO</a>
			<a onclick="cambiar_estado(<?php echo $allusers?>, 2);" class="btn btn-danger">NO ACEPTO</a>
		...
		<div class="modal fade" id="mdlSuplentes" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog modal-md">
        <div class="modal-content">
           <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal">&times;</button>
             <p style="text-align: center;"><b>VALIDACIÓN DE SOLICITUD DE REPRESENTANTE SUPLENTE DE LA ASAMBLEA GENERAL</b></p> 
           </div>
            <div class="modal-body" style="text-align: center;" >
            <img src="" alt="" class="img-fluid">
			...
			<a onclick="cambiar_suplente(<?php echo $allusers?>, 1);" class="btn btn-info">SI ACEPTO</a>
			<a onclick="cambiar_suplente(<?php echo $allusers?>, 2);" class="btn btn-danger">NO ACEPTO</a>
    ...
    <section class="sidebar">
     ...
     <?php include("view/modulos/menu.php"); ?>
        ...
        <div class="content-wrapper">
		 ...
		 <div id="si_derecho_voto"  class="jumbotron">
        </div>
        ...
        <!-- /.col -->
           ...
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>CONSULTA GENERAL DEL PARTICIPE</b></h3>
            ...
            <div class="box-body">
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-default">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed acordion1">Captaciones</a>
                  ...
                  <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="box-body">
                                        ...
                                        <div id="div_listado_cuenta_individual" class="letrasize11">
                                	
                                    		<table id="tbl_listado_cuenta_individual" class="table table-striped table-bordered">
                                    			<thead>
                                    				<tr class="danger">
               ...
               <!--  <div class="panel box box-default">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed acordion1">Cuenta por Desembolsar</a>
                    </h4>
                  </div>
                  <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="box-body">
                     
                     				<div id="div_listado_cuenta_desembolsar" class="letrasize11">
                                	
                                    		<table id="tbl_listado_cuenta_desembolsar" class="table table-striped table-bordered">
                                    			<thead>
                                    				<tr class="danger">
                                        				<th>Última Aportación</th>
                                        				<th>Aportaciones Personales</th>
                                        				<th>Aportaciones Patronales</th>
                                        				<th>Total Aportaciones</th>
                                        				<th>Retención 2% Superavit Patronal</th>
                                        				<th>Total Cuenta Desembolsar</th>
                                        				<th>Opciones</th>
                                        			</tr>                    				
                                    			</thead>                    			
                                    			<tfoot>
                ...
                <div class="panel box box-default">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed acordion1">Créditos</a>
                    </h4>
                  </div>
                  <div id="collapseThree" class="panel-collapse collapse">
                    <div class="box-body">
                                 	...
                                 	<div id="div_listado_creditos" class="letrasize11">
                                	
                                    		<table id="tbl_listado_creditos" class="table table-striped table-bordered">
                                    			<thead>
                                    				<tr class="danger">
                                        				<th>Crédito</th>
                                        				<th>Producto</th>
...
<!-- END MODAL CUENTA INDIVIDUAL -->
  ...
  <script src="view/bootstrap/plugins/input-mask/jquery.inputmask.js"></script>
    ...
    <script src="view/ServiciosOnline/js/BienvenidaOnline.js?0.45"></script>       
    <script src="view/Administracion/js/Usuarios.js?4.5"></script>       
 	<script src="view/Elecciones/js/BuscarPadron.js?4.77"></script>    
