<!DOCTYPE HTML>
          ...
          <div class="panel panel-info">
                                                       ...
                                                       <select name="id_sucursales" id="id_sucursales"  class="form-control" disabled>
                                                          <option value="0" selected="selected">--Seleccione--</option>
                        									<?php foreach($resultSucursales as $res) {?>
                        										<option value="<?php echo $res->id_oficina; ?>" <?php if ($res->id_oficina == $resEdit->id_sucursales ){  echo  ' selected="selected" '  ;}  ?> ><?php echo $res->nombre_oficina; ?> </option>
                                                      ...
                                                      <select name="id_estado_civil_datos_personales" id="id_estado_civil_datos_personales"  class="form-control" >
                                                          <option value="0" selected="selected">--Seleccione--</option>
                        									<?php foreach($resultEstado_civil as $res) {?>
                        										<option value="<?php echo $res->id_estado_civil_participes; ?>" <?php if ($res->id_estado_civil_participes == $resEdit->id_estado_civil_datos_personales ){  echo  ' selected="selected" '  ;}  ?>><?php echo $res->nombre_estado_civil_participes; ?> </option>
                        							        <?php } ?>
                        							  </select> 
            ...
            <div class="panel panel-info">
			 ...
			 <div class="row">
                    		    <div class="col-lg-3 col-xs-12 col-md-3">
                    		    <div class="form-group">
                                                      <label for="id_entidades" class="control-label">Dirección:</label>
                                                      <select name="id_entidades" id="id_entidades"  class="form-control" >
                                                          <option value="0" selected="selected">--Seleccione--</option>
                        									<?php foreach($resultEntidades as $res) {?>
                        										<option value="<?php echo $res->id_entidad_patronal; ?>"  <?php if ($res->id_entidad_patronal == $resEdit->id_entidades ){  echo  ' selected="selected" '  ;}  ?>><?php echo $res->nombre_entidad_patronal; ?> </option>
                        							        <?php } ?>
                        						      </select> 
			...
			<div class="row"> 
            					...
            					<div class="col-lg-3 col-xs-12 col-md-3">
                    		    <div class="form-group">
                                                      <label for="cargo_actual_datos_laborales" class="control-label">Denominación:</label>
                                                      <input style="text-transform: uppercase;" type="text" class="form-control" id="cargo_actual_datos_laborales" name="cargo_actual_datos_laborales" value="<?php echo $resEdit->cargo_actual_datos_laborales; ?>" placeholder="denominación..">
            ...
            <td>Cuota del Préstamo Ordinario GADPP</td>
            ...
            <td>Cuota del Préstamo Emergente GADPP</td>
           ...
           <?php } } else {?>
	         ...
	         <div class="panel-body">
			  ...
			  <div class="row">
                    		    ...
                    		    <div class="form-group">
                                                      <label for="apellidos_solicitante_datos_personales" class="control-label">Apellidos Completos:</label>
                                                      <input style="text-transform: uppercase;" type="text" class="form-control" id="apellidos_solicitante_datos_personales" name="apellidos_solicitante_datos_personales" value="<?php if(!empty($resultUsu)){foreach ($resultUsu as $res){ echo $res->apellidos_usuarios; }}else{}?>" placeholder="apellidos..">
                                                      <div id="mensaje_apellidos_solicitante_datos_personales" class="errores"></div>
                                </div>
                                </div>
                    		    ...
                    		    <div class="form-group">
                                                      <label for="nombres_solicitante_datos_personales" class="control-label">Nombres Completos:</label>
                                                      <input style="text-transform: uppercase;" type="text" class="form-control" id="nombres_solicitante_datos_personales" name="nombres_solicitante_datos_personales" value="<?php if(!empty($resultUsu)){foreach ($resultUsu as $res){ echo $res->nombre_usuarios; }}else{}?>" placeholder="nombres..">
                                                      <div id="mensaje_nombres_solicitante_datos_personales" class="errores"></div>
                                </div>
                                </div>
	         ...
	         <div class="panel-body">
			  ...
			  <div class="row">
                    		    ...
                    		    <div class="form-group">
                                                      <label for="numero_codigo_verificacion" class="control-label">Código Verificación:</label>
                                                      <input type="number" class="form-control" id="numero_codigo_verificacion" name="numero_codigo_verificacion" value="16015" placeholder="sms.." readonly>
                                                      <input type="hidden" class="form-control" id="id_codigo_verificacion" name="id_codigo_verificacion" value="5449" readonly>
			...
			<div class="row"> 
                    		    ...
                    		    <div class="form-group">
                                                      <label for="cargo_actual_datos_laborales" class="control-label">Denominación:</label>
                                                      <input style="text-transform: uppercase;" type="text" class="form-control" id="cargo_actual_datos_laborales" name="cargo_actual_datos_laborales" value="" placeholder="denominación..">
                                                      <div id="mensaje_cargo_actual_datos_laborales" class="errores"></div>
                                </div>
            					</div>         			
 ...
 <script type="text/javascript">	
	$(document).ready(function(){
	  ...
	  var id_solicitud_prestamo                                  = $("#id_solicitud_prestamo").val();
		 
     if (id_solicitud_prestamo==0){	 
	    ...
	    cargarDatos();
					...
					$.ajax({
						beforeSend:function(){},
						url:"index.php?controller=SolicitudPrestamo&action=cargarDatos",
						type:"POST",
						dataType:"json",
						data:null
					}).done(function(datos){
						...
						if(!jQuery.isEmptyObject(datos.participes)){
							...
							var array = datos.participes[0];		
							  ...
							  $("#numero_cedula_datos_personales").val(array.cedula_participes);
							  $("#apellidos_solicitante_datos_personales").val(array.apellido_participes);
							  $("#nombres_solicitante_datos_personales").val(array.nombre_participes);
							  $("#correo_solicitante_datos_personales").val(array.correo_participes);
							  $("#id_sexo_datos_personales").val(array.id_genero_participes);
							  $("#fecha_nacimiento_datos_personales").val(array.fecha_nacimiento_participes);
							  $("#id_estado_civil_datos_personales").val(array.id_estado_civil_participes);
							  $("#numero_casa_solicitante").val(array.telefono_participes);
							  $("#numero_celular_solicitante").val(array.celular_participes);
							  
							  $("#id_entidades").val(array.id_entidad_patronal);
							  $("#cargo_actual_datos_laborales").val(array.description_participes_denominaciones);
							  $("#numero_cedula_conyuge").val(array.cedula_conyugue_participes);
							  $("#apellidos_conyuge").val(array.apellido_esposa_participes);
							  $("#nombres_conyuge").val(array.nombre_conyugue_participes);
       ...
       <script >
		    ...
		    $("#generar").click(function() 
			{
				  ...
				  if (id_sucursales == 0)
			    	{
			    		...
			    		$("#mensaje_id_sucursales").fadeIn("slow"); //Muestra mensaje de error
			    		 ...
			    		 $("html, body").animate({ scrollTop: $(mensaje_id_sucursales).offset().top-120 }, tiempo);
			    		 return false;
				  ...
				  if (id_tipo_creditos == 0)
			    	{
			    		...
			    		$("#mensaje_id_tipo_creditos").fadeIn("slow"); //Muestra mensaje de error
			    		 ...
			    		 $("html, body").animate({ scrollTop: $(mensaje_id_tipo_creditos).offset().top-120 }, tiempo);
			    		 return false;
		    	...
		    	/*if (monto_datos_prestamo == 0.00)
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_monto_datos_prestamo).offset().top-120 }, tiempo);
		             return false;
			    }
		    	else 
		    	{
		    	...
		    	if (plazo_datos_prestamo == "")
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_plazo_datos_prestamo).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (destino_dinero_datos_prestamo == 0)
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_destino_dinero_datos_prestamo).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
				...
				if (tipo_participe_datos_prestamo == 0)
			    {
			    		...
			    		$("html, body").animate({ scrollTop: $(mensaje_tipo_participe_datos_prestamo).offset().top-120 }, tiempo);
			            return false;
				    }
			    	else 
			    	{
               ...
               if (tipo_participe_datos_prestamo=="Garante"){
            	   ...
            	   if (cedula_deudor_a_garantizar == "")
   			       {
   			    		...
   			    		$("html, body").animate({ scrollTop: $(mensaje_cedula_deudor_a_garantizar).offset().top-120 }, tiempo);
   			            return false;
   				    }
   			    	else 
   			    	{
            	   ...
            	   if (nombre_deudor_a_garantizar == "")
   			       {
   			    		...
   			    		$("html, body").animate({ scrollTop: $(mensaje_nombre_deudor_a_garantizar).offset().top-120 }, tiempo);
   			            return false;
   				    }
   			    	else 
   			    	{
		    	...
		    	if (tipo_pago_cuenta_bancaria==0){
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_tipo_pago_cuenta_bancaria).offset().top-120 }, tiempo);
		            return false;
				}else 
		    	{
				 ...
				 if(tipo_pago_cuenta_bancaria =='Depósito' || tipo_pago_cuenta_bancaria == 'Retira Cheque'){
				    	...
				    	if (id_banco_cuenta_bancaria == 0 )
				    	{
				            ...
				            $("html, body").animate({ scrollTop: $(mensaje_id_banco_cuenta_bancaria).offset().top-120 }, tiempo);
				            return false;
					    }
				    	else 
				    	{
				    	...
				    	if (tipo_cuenta_cuenta_bancaria == 0 )
				    	{
				            ...
				            $("html, body").animate({ scrollTop: $(mensaje_tipo_cuenta_cuenta_bancaria).offset().top-120 }, tiempo);
				            return false;
					    }
				    	else 
				    	{
				    	...
				    	if (numero_cuenta_cuenta_bancaria == "" )
				    	{
				            ...
				            $("html, body").animate({ scrollTop: $(mensaje_numero_cuenta_cuenta_bancaria).offset().top-120 }, tiempo);
				            return false;
					    }
				    	else 
				    	{
		    	...
		    	if (numero_cedula_datos_personales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_cedula_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (apellidos_solicitante_datos_personales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_apellidos_solicitante_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (nombres_solicitante_datos_personales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_nombres_solicitante_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (correo_solicitante_datos_personales == "")
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_correo_solicitante_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	...
		    	if (id_sexo_datos_personales == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_id_sexo_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (fecha_nacimiento_datos_personales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_fecha_nacimiento_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (id_estado_civil_datos_personales == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_id_estado_civil_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (separacion_bienes_datos_personales == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_separacion_bienes_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (cargas_familiares_datos_personales == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_cargas_familiares_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (numero_hijos_datos_personales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_hijos_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (nivel_educativo_datos_personales == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_nivel_educativo_datos_personales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (barrio_sector_vivienda == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_barrio_sector_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (ciudadela_conjunto_etapa_manzana_vivienda == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_ciudadela_conjunto_etapa_manzana_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
				...
				*/
		    	if (calle_vivienda == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_calle_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (referencia_direccion_domicilio_vivienda == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_referencia_direccion_domicilio_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (tipo_vivienda == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_tipo_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (vivienda_hipotecada_vivienda == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_vivienda_hipotecada_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (tiempo_residencia_vivienda == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_tiempo_residencia_vivienda).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (tipo_vivienda != "Propia"){
			    	...
			    	if (nombre_propietario_vivienda == "" )
			    	{
			            ...
			            $("html, body").animate({ scrollTop: $(mensaje_nombre_propietario_vivienda).offset().top-120 }, tiempo);
			            return false;
				    }
			    	else 
			    	{
			    	...
			    	if (celular_propietario_vivienda == "" )
			    	{
			            ...
			            $("html, body").animate({ scrollTop: $(mensaje_celular_propietario_vivienda).offset().top-120 }, tiempo);
			            return false;
				    }
			    	else 
			    	{
		    	...
		    	if (numero_celular_solicitante == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_celular_solicitante).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (numero_codigo_verificacion == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_codigo_verificacion).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (numero_casa_solicitante == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_casa_solicitante).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
		    	...
		    	if (numero_trabajo_solicitante == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_trabajo_solicitante).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (apellidos_referencia_personal == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_apellidos_referencia_personal).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (nombres_referencia_personal == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_nombres_referencia_personal).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (relacion_referencia_personal == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_relacion_referencia_personal).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (numero_telefonico_referencia_personal == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_telefonico_referencia_personal).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (apellidos_referencia_familiar == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_apellidos_referencia_familiar).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (nombres_referencia_familiar == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_nombres_referencia_familiar).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (parentesco_referencia_familiar == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_parentesco_referencia_familiar).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (numero_telefonico_referencia_familiar == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_telefonico_referencia_familiar).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (id_entidades == 0 )
		    	{
		    		...
		    		$("#mensaje_id_entidades").text("Selecione Dirección");
                ...
                if (numero_telefonico_datos_laborales == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_telefonico_datos_laborales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
				...
				*/
                ...
                if (cargo_actual_datos_laborales == "" )
		    	{
		    		...
		    		$("#mensaje_cargo_actual_datos_laborales").text("Ingrese Denominación");
		    		$("#mensaje_cargo_actual_datos_laborales").fadeIn("slow"); //Muestra mensaje de error
		            
		            $("html, body").animate({ scrollTop: $(mensaje_cargo_actual_datos_laborales).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (sueldo_total_info_economica == 0.00 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_sueldo_total_info_economica).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (otros_ingresos_1_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_1_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_1_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_1_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_1_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_1_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_2_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_2_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_2_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_2_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_2_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_2_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_3_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_3_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_3_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_3_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_3_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_3_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_4_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_4_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_4_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_4_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_4_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_4_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_5_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_5_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_5_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_5_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_5_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_5_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_6_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_6_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_6_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_6_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_6_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_6_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_7_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_7_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_7_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_7_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_7_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_7_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_ingresos_8_info_economica != "" )
		    	{
                	...
                	if (valor_ingresos_8_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_ingresos_8_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_ingresos_8_info_economica > 0.00)
		    	{
                	...
                	if (otros_ingresos_8_info_economica == ""  )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_ingresos_8_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (otros_egresos_1_info_economica != "" )
		    	{
                	...
                	if (valor_egresos_1_info_economica == 0.00 )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_valor_egresos_1_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
                ...
                if (valor_egresos_1_info_economica  > 0.00 )
		    	{
                	...
                	if ( otros_egresos_1_info_economica == "" )
    		    	{
    		            ...
    		            $("html, body").animate({ scrollTop: $(mensaje_otros_egresos_1_info_economica).offset().top-120 }, tiempo);
    		            return false;
    			    }
    		    	else 
    		    	{
			...
			if(id_estado_civil_datos_personales != 1 && id_estado_civil_datos_personales != 4 && id_estado_civil_datos_personales != 3) {
                ...
                if (numero_cedula_conyuge == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_cedula_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (apellidos_conyuge == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_apellidos_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (nombres_conyuge == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_nombres_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (id_sexo_conyuge == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_id_sexo_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (fecha_nacimiento_conyuge == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_fecha_nacimiento_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (convive_afiliado_conyuge == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_convive_afiliado_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (numero_telefonico_conyuge == "" )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_numero_telefonico_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
                ...
                if (actividad_economica_conyuge == 0 )
		    	{
		            ...
		            $("html, body").animate({ scrollTop: $(mensaje_actividad_economica_conyuge).offset().top-120 }, tiempo);
		            return false;
			    }
		    	else 
		    	{
