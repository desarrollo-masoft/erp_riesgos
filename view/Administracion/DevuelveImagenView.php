...
$image = "";
$conn =  pg_connect("host=34.239.169.3 port=5432 dbname=erp_riesgos user=postgres password=@Fcpc.2021");
...
else 
{
		...
		if (!empty($res))
		{
				...
				{
					$archivo=$_SERVER['DOCUMENT_ROOT'].'/erp_riesgos/view/images/'.'nodisponible.jpg';
