 ...
 <?php  $dias = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
  ...
  <div class="content-wrapper">
                      ...
                      <?php } } else {?>                		    
                          ...
                          <div class="row">                		      
                    		    ...
                    		    <div class="col-xs-6 col-md-3 col-lg-3">
                            		<div class="form-group">
                                      <label for="clave_usuarios" class="control-label">Password:</label>
                                      <input type="password" class="form-control" id="clave_usuarios" name="clave_usuarios" value="" placeholder="(clave..)" maxlength="8">
                                      <div id="mensaje_clave_usuarios" class="errores"></div>
                                    </div>
                            	</div>
                            	...
                            	<div class="col-lg-3 col-xs-6 col-md-3">
                        		    <div class="form-group">
                                          <label for="clave_usuarios_r" class="control-label">Repita Password:</label>
                                          <input type="password" class="form-control" id="clave_usuarios_r" name="clave_usuarios_r" value="" placeholder="(clave..)" maxlength="8">
                                          <div id="mensaje_clave_usuarios_r" class="errores"></div>
                                    </div>
                                </div>
   ...
   <script src="view/bootstrap/plugins/input-mask/jquery.inputmask.js"></script>
    ...
    <script src="view/Administracion/js/Usuarios.js?3.9"></script>         	
  </body>
</html>
